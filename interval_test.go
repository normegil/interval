...
func TestNewIntegerInterval(t *testing.T) {
	...
	for _, test := range tests {
		i, err := interval.NewIntegerInterval(test.min, test.max, test.minIncluded, test.maxIncluded)
		if nil != err {
...
func TestNewIntegerInterval_Errors(t *testing.T) {
	...
	for _, test := range tests {
		_, err := interval.NewIntegerInterval(test.min, test.max, test.minIncluded, test.maxIncluded)
		if nil == err {
...
func TestParseIntervalInteger(t *testing.T) {
	...
	for _, test := range tests {
		i, err := interval.ParseIntervalInteger(test.input)
		if nil != err {
...
func TestParseIntervalInteger_Errors(t *testing.T) {
	...
	for _, test := range tests {
		_, err := interval.ParseIntervalInteger(test)
		if nil == err {
			t.Errorf("Error when running test with: %+v. Expected error.", test)
		}
	}
...
func TestInclude(t *testing.T) {
	...
	for _, test := range tests {
		i, err := interval.ParseIntervalInteger(test.interval)
		if nil != err {
